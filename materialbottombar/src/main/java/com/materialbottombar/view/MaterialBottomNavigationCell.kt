package com.materialbottombar.view
...
import com.materialbottombar.R
import com.materialbottombar.databinding.MaterialBottomNavigationCellBinding
import com.materialbottombar.utils.dp
import com.materialbottombar.utils.ofColorStateList
import com.materialbottombar.utils.runAfterDelay
import com.materialbottombar.utils.updateLayoutParams

class MaterialBottomNavigationCell@JvmOverloads constructor(
    context: Context,
    ...
    private val binding = MaterialBottomNavigationCellBinding.inflate(LayoutInflater.from(context), this)
    ...
    private var iconSize = 56f.dp(context)
        set(value) {
            field = value
            if (allowDraw) {
