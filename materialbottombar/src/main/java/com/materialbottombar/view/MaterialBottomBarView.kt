...
class MaterialBottomBarView @JvmOverloads constructor(
    context: Context,
    ...
    init {
        ...
        mainPaint?.apply {
            ...
            color = this@MaterialBottomBarView.color
        }
    ...
    override fun onMeasure(widthMeasureSpec: Int, heightMeasureSpec: Int) {
        ...
        bezierOuterWidth = 82f.dp(context)
        bezierOuterHeight = 10f.dp(context)
        bezierInnerWidth = 124f.dp(context)
        bezierInnerHeight = 20f.dp(context)
